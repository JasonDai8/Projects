    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        livingGhostPositionDistributions = \
            [beliefs for i, beliefs in enumerate(self.ghostBeliefs)
             if livingGhosts[i+1]]
        "*** YOUR CODE HERE ***"
        likelyghostPos = [distribution.argMax() for distribution in livingGhostPositionDistributions]
    
        closestGhost = min(likelyghostPos, key=lambda ghostPos: abs(self.distancer.getDistance(pacmanPosition, ghostPos)))
